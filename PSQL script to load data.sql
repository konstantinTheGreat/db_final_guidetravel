...
\COPY staging_users (UserID, Username, Email, Password, ProfilePicture, Role) FROM '/Users/user/Downloads/data_set1_users.csv' DELIMITER ',' CSV HEADER;
\COPY staging_rooms (RoomID, RoomName, CreatedBy, CreatedAt) FROM '/Users/user/Downloads/data_set2_rooms.csv' DELIMITER ',' CSV HEADER;

--Step 3: Now merge with the actual tables in our database

INSERT INTO GuideToursApp.Users (Username, Email, Password, ProfilePicture, Role)
